...
#[derive(Debug)]
pub struct FetchAiAgentProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FetchAiAgentProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FetchAiAgent processing");
    
    let mut processor = FetchAiAgentProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FetchAiAgentProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FetchAiAgentProcessor::new(false);
